  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 flex items-start justify-end p-4 sm:p-6" onClick={onClose}>
      <div role="dialog" aria-modal="true" aria-label={`Incoming call about ${b.name}`} onClick={(e) => e.stopPropagation()} className="bg-white w-full max-w-sm rounded-xl shadow-2xl overflow-hidden animate-slidein">
        <div className="bg-[#053a4e] text-white px-4 py-3 flex items-center gap-2">
          <span className="w-9 h-9 rounded-full bg-[#1aa0c4] grid place-items-center"><Phone size={16} /></span>
        ...
        <div className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[13px] text-[#0a6e8c] font-semibold">"{b.name}" · {b.engine}</div>
            </div>
          </div>
          ...
          <div className="mt-3 bg-[#f7fbfd] border border-[#dcebf1] rounded-md p-3">
            <div className="text-[11px] font-bold uppercase tracking-wide text-[#0a6e8c] mb-1">Talk track</div>
          ...
          <div className="flex gap-2 mt-4">
            <button onClick={() => onOpen(boatId)} className="flex-1 bg-[#1aa0c4] hover:bg-[#1690b0] text-white text-sm font-semibold rounded-md h-9">Open record</button>
